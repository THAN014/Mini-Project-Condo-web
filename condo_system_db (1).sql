...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2025 at 04:10 PM
...
INSERT INTO `purchases` (`Purchase_id`, `Room_id`, `User_id`, `Room_price`) VALUES
(4, 9, 20001, 1235602);
...
(11, 8, 'admin', 20001, 'nujty', '28767867', 'verver@gmail.com');
...
(8, '101', 0, 890000, 'reserve', 'ANBY', 12, 54, 20001, 'astra.jpg'),
(9, '333', 0, 1235602, 'Sold', 'ASTRA', 42, 100, 20001, 'TEsting1.jpg');
...
--
ALTER TABLE `purchases`
  MODIFY `Purchase_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `reserve`
--
ALTER TABLE `reserve`
  MODIFY `Reserve_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
