...
if ($result->num_rows === 0) {
    die("ไม่พบข้อมูลการจองสำหรับห้องนี้ <a href='manage_room.php'>กลับ</a>");
}
...
<head>
    ...
    <title>ข้อมูลการจองห้อง - Admin Dashboard</title>
        ...
        <div class="main-content p-3 p-md-4">
            <header class="d-flex justify-content-between align-items-center pb-3 mb-4 border-bottom">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="h4 mb-0 fw-bold">ข้อมูลการจองห้อง</h2>
                </div>
                <div class="d-flex align-items-center">
                     <div class="d-flex align-items-center">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-header bg-white py-3">
                           <h5 class="mb-0 fw-bold"><i class="bi bi-person-fill me-2"></i>ข้อมูลผู้จอง</h5>
                        </div>
                         <div class="card-body">
                           <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
